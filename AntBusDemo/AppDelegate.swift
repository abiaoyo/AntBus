...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, willFinishLaunchingWithOptions launchOptions: [UIApplication.LaunchOptionsKey : Any]? = nil) -> Bool{
        ...
        AntBusChannel.groupNotification.register("TestGroupKey", group: "AppDelegate", owner: self) { group, groupIndex, data in
...
//        for module in ModuleManager.shared.allModules() {
//            module.moduleApplication(application, didFinishLaunching: launchOptions)
//        }
        return true
    }
}
